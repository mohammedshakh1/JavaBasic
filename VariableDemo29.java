public class VariableDemo29{

    public static void main(String[] args){
        System.out.println("Trial Number 13 in learning java basic");
    ...
    float valueOfPie2 = 3.141592f;
    System.out.println("Value of Pie 2 " + valueOfPie2);
